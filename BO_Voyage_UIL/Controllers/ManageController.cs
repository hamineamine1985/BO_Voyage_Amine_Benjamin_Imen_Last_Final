...
namespace BO_Voyage_UIL.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public ActionResult LinkLogin(string provider)
        {
            ...
            //return new HomeController.ChallengeResult(provider, Url.Action("LinkLoginCallback", "Manage"), User.Identity.GetUserId());            // Demander une redirection vers le fournisseur de connexion externe afin de lier une connexion pour l'utilisateur actuel
