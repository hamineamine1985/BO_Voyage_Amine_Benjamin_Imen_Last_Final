    ...
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            app.UseFacebookAuthentication(
               appId: "326410918201203",
               appSecret: "a1bfbb811c809ffc810d1fe031afed1e");

            app.UseGoogleAuthentication(new GoogleOAuth2AuthenticationOptions()
            {
                ClientId = "954828968370-uogd88dqiep65s7hnvtni3101mlbdj14.apps.googleusercontent.com",
                ClientSecret = "l47C4vCQI6zwtBiN_lUuZfZq"
            });
        }
    }
}